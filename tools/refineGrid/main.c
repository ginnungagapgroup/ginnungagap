...
/**
 * @file refineGrid/main.c
 * @ingroup  toolsrefineGridMain
 * @brief  Implements the main routine for refineGrid.
 */
...
/*--- Local defines -----------------------------------------------------*/
#define THIS_PROGNAME "refineGrid"
...
/**
 * @defgroup toolsrefineGridMain Driver routine
 * @ingroup  toolsrefineGrid
 * @brief  Provides the driver for @ref toolsrefineGrid.
 *
 * This page describes how to run refineGrid from the command
 * line.
 *
 * @section toolsRSCSynopsis Synopsis
 * <code>refineGrid [--version] [--help] arg0</code>
 *
 ...
 * tools/refineGrid/main.c, please check that file for the latest
