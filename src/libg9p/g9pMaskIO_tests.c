...
g9pMaskIO_verifyReadWriteSimple(void)
{
	...
	g9pMask_t m = g9pMaskIO_newFromIni(ini, "Mask", NULL);
	g9pMask_t m2 = g9pMaskIO_newFromIni(ini, "Mask", NULL);
	const gridPointUint32_t cell[3] = {{16, 16, 16}, {16, 16, 17}, {16, 15, 16}};
...
local_checkMasksAreEqual(g9pMask_t m1, g9pMask_t m2)
{
	...
	if (g9pMask_getNumCellsInMaskTile(m1) != g9pMask_getNumCellsInMaskTile(m2))
		return false;
